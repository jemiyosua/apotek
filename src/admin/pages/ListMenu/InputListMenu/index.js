        ...
        if(validasiMessage!=""){
            ...
            .then((data) => {
                ...
                if(data.ErrorCode=="0"){
                    history.push({
                        pathname: '/list-menu',
                        state: { Message : "Berhasil Insert Data" }
                      })
                }else{
                    if(data.ErrorMessage=="Param Key Exipred"){
                        ...
                        setErrorMessageAlert("Gagal memasukkan data.");
                        setShowAlert(true);
                    }
                }
            })
    ...
    return (
        <div className="main-page">
            ...
            <div className="blog-post">
                ...
                <p className="title"><a href="/list-menu"><FontAwesomeIcon icon={faArrowAltCircleLeft}/></a> Buat Menu Baru</p>
                ...
                <div className="button-action">
                    <Button 
                        ...
                        spinner={IsLoading2} 
                        onClick={()=>simpanData()}
                    ><FontAwesomeIcon icon={faCheckCircle}/> SIMPAN</Button>
                </div>
